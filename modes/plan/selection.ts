...
// Let the user choose which generated plan steps should be executed.
...
// Render the generated plan in a compact terminal-friendly format.
export const printPlan = (plan: Plan) => {
